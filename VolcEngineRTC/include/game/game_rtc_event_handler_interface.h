...
public:
     ...
     */
    virtual void OnJoinRoomResult(const char* room_id, const char* user_id,
            JoinRoomErrorCode error_code,
            bool is_rejoined, int elapsed) {
        (void)room_id;
        (void)user_id;
        (void)error_code;
        (void)is_rejoined;
     ...
     */
    virtual void OnAudioDeviceRecordStart() {
    }
     ...
     */
    virtual void OnAudioDeviceRecordStop() {
    }
     ...
     */
    virtual void OnAudioDevicePlayoutStart() {
    }
     ...
     */
    virtual void OnAudioDevicePlayoutStop() {
    }
